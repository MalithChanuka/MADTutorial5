...
public class MainActivity extends AppCompatActivity
{
    ...
    com.example.tutorila5.Student std;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        std = new com.example.tutorila5.Student();

        btnSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                dbRef = (DatabaseReference) FirebaseDatabase.getInstance().getReference().child("Student");
                try{
        ...
        btnShow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                DatabaseReference readRef = (DatabaseReference) FirebaseDatabase.getInstance().getReference().child("Student").child("std1");
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                DatabaseReference updRef = (DatabaseReference) FirebaseDatabase.getInstance().getReference().child("Student");
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        if (dataSnapshot.hasChild("std1"))
                        {
                            try{
                                ...
                                dbRef = (DatabaseReference) FirebaseDatabase.getInstance().getReference().child("Student").child("std1");
                                dbRef.setValue(std);
                                clearControls();
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                DatabaseReference delRef = (DatabaseReference) FirebaseDatabase.getInstance().getReference().child("Student");
